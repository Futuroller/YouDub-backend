...
CREATE TABLE "YouDub".users (
	...
	subscribers_count int8 NULL,
	is_banned bool DEFAULT false NOT NULL,
	ban_reason varchar NULL,
	channel_header_url varchar NULL,
	CONSTRAINT users_pk PRIMARY KEY (id),
	CONSTRAINT users_unique UNIQUE (emai),
	CONSTRAINT users_roles_fk FOREIGN KEY (id_role) REFERENCES "YouDub".roles(id)
);
CREATE INDEX users_id_idx ON "YouDub".users USING btree (id, username, emai, password_hash, registration_date, avatar_url, channel_header_url, description, subscribers_count, "is_activated", activation_link, is_banned, ban_reason, id_role);
